...
public class StoreupController {
    ...
    public R save(@RequestBody StoreupEntity storeup, HttpServletRequest request){
    	...
    	storeup.setUserid((Long)request.getSession().getAttribute("userId"));
       boolean success= storeupService.insert(storeup);
	   if(success){
		   JingdianxinxiEntity entity=new JingdianxinxiEntity();
		   entity.setId(storeup.getRefid());
		   entity.setStoreup(1);
		   jingdianxinxiService.updateById(entity);
	   }
        return R.ok();
    }
